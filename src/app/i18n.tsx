...
const dictionaries = {
	zh: {
		...
		"upload.fileSizeHint": "支持最大 100MB 的文件",
		"upload.expiry": "保存期限",
		...
		"room.joinRoom": "加入房间",
		"room.roomCode": "房间号",
		"room.enterRoomCode": "输入房间号",
		"room.roomCreated": "房间已创建",
		"room.roomJoined": "已加入房间",
		"room.roomNotFound": "房间不存在",
		"room.roomDestroyed": "房间已关闭",
		"room.uploadText": "上传文本",
		"room.uploadFile": "上传文件",
		"room.fileList": "文件列表",
		"room.fileName": "文件名",
		"room.fileType": "类型",
		"room.uploadTime": "上传时间",
		"room.remaining": "剩余",
		"room.expires": "过期",
		"room.noFiles": "暂无文件",
		"room.clients": "{count} 人",
		"room.connecting": "连接中...",
		"room.creating": "创建中...",
		"room.joining": "加入中...",
		"room.exitRoom": "退出房间",
		"room.copyCode": "复制房间号",
		"message.roomCreateFailed": "创建房间失败",
		"message.roomJoinFailed": "加入房间失败",
		"message.roomUploadFailed": "上传失败",
		"message.roomFileStored": "文件已上传",
		"message.roomTextStored": "文本已上传",
	},
	en: {
		...
		"upload.fileSizeHint": "Supports files up to 100 MB",
		...
		"room.modeSwitch": "Room",
		"room.lockerMode": "Locker",
		"room.or": "or",
		"room.createRoom": "Create Room",
		"room.joinRoom": "Join Room",
		"room.roomCode": "Room Code",
		"room.enterRoomCode": "Enter Room Code",
		"room.roomCreated": "Room Created",
		"room.roomJoined": "Joined Room",
		"room.roomNotFound": "Room Not Found",
		"room.roomDestroyed": "Room Closed",
		"room.uploadText": "Upload Text",
		"room.uploadFile": "Upload File",
		"room.fileList": "File List",
		"room.fileName": "File Name",
		"room.fileType": "Type",
		"room.uploadTime": "Upload Time",
		"room.remaining": "Remaining",
		"room.expires": "Expires",
		"room.noFiles": "No Files",
		"room.clients": "{count} users",
		"room.connecting": "Connecting...",
		"room.creating": "Creating...",
		"room.joining": "Joining...",
		"room.exitRoom": "Exit Room",
		"room.copyCode": "Copy Code",
		"message.roomCreateFailed": "Failed to create room",
		"message.roomJoinFailed": "Failed to join room",
		"message.roomUploadFailed": "Upload failed",
		"message.roomFileStored": "File uploaded",
		"message.roomTextStored": "Text uploaded",
	},
} as const;
